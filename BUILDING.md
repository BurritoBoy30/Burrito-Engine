# Building Friday Night Funkin': Burrito Engine
...
2. `git clone https://github.com/BurritoBoy30/Burrito-Engine.git`
3. `cd` into the source code: `cd Burrito-Engine`
...
- The build will be in `Burrito-Engine/export/<target>/bin`, with `<target>` being the target you built to in the previous step. (i.e. `Kade-Engine/export/windows/bin`)
