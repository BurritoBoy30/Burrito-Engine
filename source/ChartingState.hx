...
{	
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var player1DropDown = new FlxUIDropDownMenu(10, box_offeset + 70, FlxUIDropDownMenu.makeStrIdLabelArray(characters, true), function(character:String)
		{
			_song.player1 = characters[Std.parseInt(character)];
		});
		player1DropDown.selectedLabel = _song.player1;

		var player1Label = new FlxText(10,box_offeset + 55,64,'Boyfriend');

		var player2DropDown = new FlxUIDropDownMenu(140, box_offeset + 70, FlxUIDropDownMenu.makeStrIdLabelArray(characters, true), function(character:String)
		{
			_song.player2 = characters[Std.parseInt(character)];
		});
		player2DropDown.selectedLabel = _song.player2;

		var player2Label = new FlxText(140,box_offeset + 55,64,'Opponent');

		var gfVersionDropDown = new FlxUIDropDownMenu(10, box_offeset + 110, FlxUIDropDownMenu.makeStrIdLabelArray(gfVersions, true), function(gfVersion:String)
		{
			_song.gfVersion = gfVersions[Std.parseInt(gfVersion)];
		});
		gfVersionDropDown.selectedLabel = _song.gfVersion;
		
		var gfVersionLabel = new FlxText(10,box_offeset + 95,64,'Girlfriend');
		
		var stageDropDown = new FlxUIDropDownMenu(10, box_offeset + 150, FlxUIDropDownMenu.makeStrIdLabelArray(stages, true), function(stage:String)
		{
			_song.stage = stages[Std.parseInt(stage)];
		});
		stageDropDown.selectedLabel = _song.stage;
		
		var stageLabel = new FlxText(10,box_offeset + 135,64,'Stage');
	...
	{	
		...
		var applyLength:FlxButton = new FlxButton(190, 10, 'Apply');
		
		var noteStyleDropDown = new FlxUIDropDownMenu(10, 200, FlxUIDropDownMenu.makeStrIdLabelArray(noteStyles, true), function(noteStyle:String)
		{
			_song.noteStyle = noteStyles[Std.parseInt(noteStyle)];
		});
		noteStyleDropDown.selectedLabel = _song.noteStyle;
		
		var noteStyleLabel = new FlxText(10,185,64,'Note Skin');

		tab_group_note.add(stepperSusLength);
		tab_group_note.add(stepperSusLengthLabel);
		tab_group_note.add(applyLength);
		tab_group_note.add(noteStyleDropDown);
		tab_group_note.add(noteStyleLabel);
