...
class Ratings
{
    ...
    {
        return 
        (FlxG.save.data.npsDisplay ? "NPS: " + nps + " (Max " + maxNPS + ")" + (!PlayState.botplayON ? " | " : "") : "") + (!PlayState.botplayON ?	// NPS Toggle
        "Score:" + (Conductor.safeFrames != 10 ? score + " (" + scoreDef + ")" : "" + score) + 									// Score
        " | Misses:" + PlayState.misses + 																						// Misses/Combo Breaks
        " | Accuracy:" + (PlayState.botplayON ? "?" : PlayState.truncateFloat(accuracy, 2) + " %") +  							// Accuracy
